 ...
 * @author user
 */
@WebServlet(name = "EstudiantesPierden", urlPatterns = {"/EstudiantesPierden"})
public class EstudiantesPierden extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(EstudiantesPierden.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
