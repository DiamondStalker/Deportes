...
public class MensajesErrores {
     ...
     public static String Pierden = "</html> "
            + "<!DOCTYPE html>\n"
            + "<html>\n"
            + "<body onload=\"mensaje()\">\n"
            + "\n"
            ...
            + "<script>\n"
            + "function mensaje() {\n"
            + "    alert('No hay estudiantes que pierden')\n"
            + "    window.location.href = 'administrador.jsp?id=';  \n"
            + "}\n"
            + "</script>\n"
            + "\n"
            + "</body>\n";
     
     public static String Mejor = "</html> "
            + "<!DOCTYPE html>\n"
            + "<html>\n"
            + "<body onload=\"mensaje()\">\n"
            + "\n"
            ...
            + "<script>\n"
            + "function mensaje() {\n"
            + "    alert('No hay mejores estudiantes')\n"
            + "    window.location.href = 'administrador.jsp?id=';  \n"
            + "}\n"
            + "</script>\n"
            + "\n"
     ...
     public static String Ganan = "</html> "
            + "<!DOCTYPE html>\n"
            + "<html>\n"
            + "<body onload=\"mensaje()\">\n"
            + "\n"
            ...
            + "<script>\n"
            + "function mensaje() {\n"
            + "    alert('No hay estudiantes que ganan')\n"
            + "    window.location.href = 'administrador.jsp?id=';  \n"
            + "}\n"
            + "</script>\n"
            + "\n"
    ...
    public static String Nosecambioc = "</html> "
            ...
            + "    window.location.href = 'docente.jsp?id=123';  \n"
            + "}\n"
            + "</script>\n"
            + "\n"
            + "</body>\n";
    ...
    public static void setDocente(String Docente) {
